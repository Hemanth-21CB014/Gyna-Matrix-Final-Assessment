...
function c(){
    ...
    color={
        8:["#e7a2a2","red","Gyna Matrix Ass/Images/red.png"],
        2:["#e7a2a2","red","Gyna Matrix Ass/Images/red.png"],
        3:["e7a2a2","red","Gyna Matrix Ass/Images/red.png"],
        0:["#e7a2a2","red","Gyna Matrix Ass/Images/red.png"],
        5:["#adeee4","green","Gyna Matrix Ass/Images/green.png"],
        1:["#adeee4","green","Gyna Matrix Ass/Images/green.png"]
    }
